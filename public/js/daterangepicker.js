...
(function(root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.locale = {
            ...
            daysOfWeek: $.datepicker._defaults.dayNamesShort,
        ...
        if (typeof options.resetButton === 'boolean')
        ...
        if (this.autoApply && typeof options.ranges !== 'object') {
            ...
            this.container.find('.applyBtn, .cancelBtn').addClass('d-none');
        ...
        if(this.resetButton) {
            ...
            this.container.find('.resetBtn').removeClass('d-none');
        }
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            //
            if(this.linkedCalendars == false && side == 'right')
            {   
                return;
            }
