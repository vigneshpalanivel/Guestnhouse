 ...
 * @private
 */
InfoBubble.prototype.AUTOPAN_MARGIN_ = 35;
...
InfoBubble.prototype.buildDom_ = function() {
    ...
    arrowOuter.style['left'] = arrowInner.style['left'] = '10%';
    ...
    var css = '.' + this.animationName_ + '{-webkit-animation-name:' +
        this.animationName_ + ';-webkit-animation-duration:0.5s;' + ';margin-left:25px;' +
...
InfoBubble.prototype.panToView = function() {
    ...
    var spaceTop = markerPosition.y - infobubbleHeight - arrowHeight - anchorHeight - autopanMargin - 60; // calculate free space or overrun at the top (including the autopan margin) - pixels
...
InfoBubble.prototype.setTabStyle_ = function(tab) {
    ...
    var styles = {
        ...
        'zIndex': index,
        'display': 'none' //inline display none the tab
    };
