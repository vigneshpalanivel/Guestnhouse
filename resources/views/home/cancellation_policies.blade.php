...
<main id="site-content" role="main">
  <div class="cancel-policy py-4 py-md-5">
    <div class="container">
      <h3>
        {{trans('messages.cancellation_policy.cancellation_policies')}}
      </h3>
      <p>
        {{trans('messages.cancellation_policy.site_cancel_policy_description_content', ['site_name' => $site_name])}}
      </p>
      <div class="card">
        <ul class="d-flex card-header tabs tabs-header py-0" role="tablist" data-permalink="true">
          <li>
          <a href="#flexible" aria-controls="flexible" aria-selected="true" class="tab-item normal-link flexible" role="tab">{{trans('messages.cancellation_policy.flexible')}}
            </a>
          </li>
          <li>
          <a href="#moderate" aria-controls="moderate" aria-selected="false" class="tab-item normal-link moderate" role="tab">{{trans('messages.cancellation_policy.moderate')}}
            </a>
          </li>
          <li>
          <a href="#strict" aria-controls="strict" aria-selected="false" class="tab-item normal-link strict" role="tab">{{trans('messages.cancellation_policy.strict')}}
            </a>
          </li>
        </ul>
        <div class="card-body">
          <div id="flexible" class="card-body tab-panel" role="tabpanel" aria-hidden="false">
            ...
            <div class="timeline-container d-none d-md-block">
              <div class="d-flex">
          ...
          <div id="moderate" class="panel-body tab-panel" role="tabpanel" aria-hidden="true">
              ...
              <div class="d-flex">
                ...
                <div class="col-md-4 timeline-segment timeline-segment-nonrefundable">
                  <div id="third-point" class="timeline-point">
                    ...
                    <div class="timeline-point-label">
                      {{trans('messages.cancellation_policy.mon_jul_20')}}
                      <br>{{trans('messages.cancellation_policy.11am')}}
                    </div>
                  </div>
                </div>
            ...
            <div class="row cancel-info">
              <div class="col-md-4">
                <p>
                  {{trans('messages.cancellation_policy.moderate_full_refund_5_days_prior_from_checkin_time')}}
                </p>
              </div>
              <div class="col-md-4">
                <p>
                  {{trans('messages.cancellation_policy.moderate_less_than_5_days_in_advance_1st_night_50%_not')}}
                </p>
              </div>
              <div class="col-md-4">
                <p>
                  {{trans('messages.cancellation_policy.moderate_not_spent_50%_refunded')}}
                </p>
              </div>
            </div>
          </div>
