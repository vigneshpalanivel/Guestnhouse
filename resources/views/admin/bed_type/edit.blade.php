  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="../bed_type">Bed Type</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/edit_bed_type/'.$result->id, 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
              <div class="box-body">
...
@endforeach
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::File('images', ['class' => 'form-control', 'id' => 'input_icon_name_1', 'placeholder' => 'Icon', 'rows' => 3]) !!}
                    <span class="text-danger">{{ $errors->first('image') }}</span>
                    <p class="note_text">(Note: Upload size maximum 50px * 50px)</p>
                    @if($result->icon)
                      <img width="40" height="40" src="{{$result->icon}}">
                    @endif
                  </div>
                </div>
