      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/add_bed_type', 'class' => 'form-horizontal','id'=>'form','files'=>true]) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
               ...
               <div class="multiple_lang_add">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::File('image', ['class' => 'form-control', 'id' => 'input_icon_name_1', 'placeholder' => 'Icon', 'rows' => 3] ) !!}
